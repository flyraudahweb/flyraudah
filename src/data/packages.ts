...
export const packages: TravelPackage[] = [
  ...
  },
  {
    ...
    inclusions: [
      "Visa processing",
      "Return flight ticket (Saudi Airlines)",
      "Ground transportation",
      "Premium hotel accommodation",
      "Breakfast daily",
      "Ziyarat tours",
  ...
  {
    id: "PKG-UMRAH-RAM-STD-KNO-001",
    name: "Ramadan Umrah 2026 - Standard (Kano)",
    type: "umrah",
    category: "standard",
    season: "ramadan",
    year: 2026,
    ...
    duration: "14-16 days",
    dates: [
      { id: "RAM-STD-001", outbound: "2026-02-18", outboundRoute: "Kano → Jeddah", return: "2026-03-04", returnRoute: "Jeddah → Kano", airline: "MaxAir" },
      { id: "RAM-STD-002", outbound: "2026-02-23", outboundRoute: "Kano → Jeddah", return: "2026-03-09", returnRoute: "Jeddah → Kano", airline: "MaxAir" },
      { id: "RAM-STD-003", outbound: "2026-02-25", outboundRoute: "Kano → Jeddah", return: "2026-03-11", returnRoute: "Jeddah → Kano", airline: "MaxAir" },
      { id: "RAM-STD-004", outbound: "2026-03-01", outboundRoute: "Kano → Jeddah", return: "2026-03-15", returnRoute: "Jeddah → Kano", airline: "MaxAir" },
      { id: "RAM-STD-005", outbound: "2026-03-02", outboundRoute: "Kano → Jeddah", return: "2026-03-16", returnRoute: "Jeddah → Kano", airline: "MaxAir" },
      { id: "RAM-STD-006", outbound: "2026-03-05", outboundRoute: "Kano → Jeddah", return: "2026-03-19", returnRoute: "Jeddah → Kano", airline: "MaxAir" },
      { id: "RAM-STD-007", outbound: "2026-03-06", outboundRoute: "Kano → Jeddah", return: "2026-03-20", returnRoute: "Jeddah → Kano", airline: "MaxAir" },
      { id: "RAM-STD-008", outbound: "2026-03-08", outboundRoute: "Kano → Jeddah", return: "2026-03-22", returnRoute: "Jeddah → Kano", airline: "MaxAir" },
      { id: "RAM-STD-009", outbound: "2026-03-11", outboundRoute: "Kano → Jeddah", return: "2026-03-25", returnRoute: "Jeddah → Kano", airline: "MaxAir" },
    ],
    makkah: {
  ...
  {
    id: "PKG-UMRAH-SHAB-STD-EGA-001",
    name: "Sha'ban Umrah 2026 - Standard (EgyptAir)",
    type: "umrah",
    category: "standard",
    season: "shaban",
    year: 2026,
  ...
  {
    id: "PKG-UMRAH-SHAB-STD-FDA-001",
    name: "Sha'ban Umrah 2026 - Standard (Fly Adeal)",
    type: "umrah",
    category: "standard",
    season: "shaban",
    year: 2026,
